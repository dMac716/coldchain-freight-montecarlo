...
## Download Results & Code { .section-title }

::: {.panel}
[Download Submission Package (11 MB)](assets/transport/downloads/coldchain_submission_package.zip){.btn-pill style="background: var(--primary); border-color: var(--primary); font-size: 1rem; padding: 0.5rem 1.2rem;"}

Includes: 72,872-row dataset, 20 figures, 10 tables, analysis code, simulation engine, tests, and documentation.

See also: [GitHub Repository](https://github.com/dMac716/coldchain-freight-montecarlo) for the full codebase.
:::
