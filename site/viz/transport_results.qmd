...
## Total Runs: 70,174 validated across 8 scenarios
...
::: {.callout-warning}
**Note:** The route comparison animations below were generated from the earlier 80-run baseline and show stale reefer/diesel and reefer/electric values (both at 0). These animations will be regenerated from the 70,174-run audit dataset.
:::
