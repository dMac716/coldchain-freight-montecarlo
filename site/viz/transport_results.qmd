...
## Total Runs: 75,443 validated across 8 scenarios
...
Production audit: `audit_2026-03-17` | **75,443 runs** | 8 scenarios
...
- Total runs: 75,443 (deduplicated)
...
## Production Audit Results (75,443 runs)
...
::: {.callout-note}
**Updated:** Route comparison animations regenerated from the 75,443-run master dataset with correct reefer metrics (diesel TRU: 11.2 gal/trip, BEV electric TRU: 439 kWh/trip).
:::
