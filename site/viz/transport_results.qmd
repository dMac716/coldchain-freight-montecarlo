...
## Total Runs: 59,434 validated across 8 scenarios
...
Production audit: `audit_2026-03-17` | **59,434 runs** | 8 scenarios
...
- Total runs: 59,434 (deduplicated)
...
## Production Audit Results (59,434 runs)
...
::: {.callout-warning}
**Note:** The route comparison animations below were generated from the earlier 80-run baseline and show stale reefer/diesel and reefer/electric values (both at 0). These animations will be regenerated from the 59,434-run audit dataset.
:::
