...
bev_detail <- bev_dt[, .(
  ...
  mean_charge_stops = round(mean(charge_stops, na.rm = TRUE), 2),
  median_charge_stops = median(charge_stops, na.rm = TRUE),
  p05_charge_stops = quantile(charge_stops, 0.05, na.rm = TRUE),
  p95_charge_stops = quantile(charge_stops, 0.95, na.rm = TRUE),
  mean_time_charging_min = round(mean(time_charging_min, na.rm = TRUE), 1),
